...
public class DatabaseCommand {
	...
	public void doImport(String pathToDirectory, String importerId, @Nullable String deletePlayerState)
			throws Exception {
		...
		if (FileHelper.hiddenFolderExist(pathToDirectory, importerId) == true) {
			...
			boolean foldersAreTheSame = FileHelper.compareFolders(pathToDirectory,
			...
			if (foldersAreTheSame == true) {
				...
				System.out.println("WARNING! You are about to remove player state. "
						+ "If you want to procced, please run the command again with the flag ```deletePlayerState``` setted to true");

...
public class AuthenticationController extends BaseController {
	...
	public AuthToken authenticate(@ApiParam(value = "mail and password") @RequestBody AuthUser loginUser) throws org.springframework.security.core.AuthenticationException, AuthenticationException {

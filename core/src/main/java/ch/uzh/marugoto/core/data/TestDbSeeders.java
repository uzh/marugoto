...
public class TestDbSeeders {
	...
	public void createData() {
		...
		var testComponent1 = componentRepository
				.save(new TextComponent(0, 300, 200, 200, "# Some example text for component"));

		var testExercise1 = new TextExercise(100, 100, 400, 400, 5, 25, "What does 'domo arigato' mean?", null, 20);
